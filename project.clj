(defproject org.domaindrivenarchitecture/dda-backup-crate "0.3.0-SNAPSHOT"
 ...
 :profiles {:dev
            {:dependencies
             [[com.palletops/pallet "0.8.11" :classifier "tests"]
              [org.domaindrivenarchitecture/dda-pallet-commons "0.1.0-SNAPSHOT" :classifier "tests"]]
             :plugins
