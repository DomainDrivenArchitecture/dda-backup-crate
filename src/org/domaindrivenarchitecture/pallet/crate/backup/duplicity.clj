...
(defn configure []
  ...
  (actions/remote-file "/var/opt/backup/" :local-file "/home/hel/.pallet/9C26059F_pub.key" :owner "root", :group "users" :mode "700"
  :action :create :force true)
  (actions/remote-file "/var/opt/backup/" :local-file "/home/hel/.pallet/9C26059F_priv.key" :owner "root", :group "users" :mode "700"
  :action :create :force true)
  (actions/exec-script* "gpg --import /var/opt/backup/9C26059F_pub.key && gpg --import /var/opt/backup/9C26059F_priv.key" )
  (actions/remote-file "/var/opt/backup/" :local-file "/home/hel/.pallet/trust.sh" :owner "root", :group "users" :mode "700"
  :action :create :force true)
