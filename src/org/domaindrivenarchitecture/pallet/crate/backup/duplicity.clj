...
(defn configure []
  ...
  (actions/rsync "~/.pallet/9C26059F_pub.key" "/var/opt/backup/" 22)
  (actions/rsync "~/.pallet/9C26059F_priv.key" "/var/opt/backup/" 22)
  (actions/exec-script* "gpg --import /var/opt/backup/9C26059F_pub.key && gpg --import /var/opt/backup/9C26059F_priv.key" )
  (actions/rsync "~/.pallet/trust.sh" "/var/opt/backup/" 22)
