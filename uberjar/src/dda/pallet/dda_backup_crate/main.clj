...
(ns dda.pallet.dda-backup-crate.main
  (:gen-class)
  (:require
...
(defn usage [options-summary]
  (str/join
   \newline
   ["The dda-backup-crate provides installation & configuration of application backup"
    "environment. Supported transport backend is duplicity."
    ""
    "Usage: java -jar dda-backup-crate-[version]-standalone.jar [options] backup.edn"
    ""
    "Options:"
    options-summary
    ""
    ...
    "  - has to be a valid DomainConfig (see: https://github.com/DomainDrivenArchitecture/dda-backup-crate)"
    ""]))
